...
let content_3 =   '	<h3 class="heading heading__dark">';
    ...
    content_3 +=  '			  Do you want to know how to <span class="highlighted"><a href="move_snake.html">move your snake and creating food</a></span> for it?';
    content_3 +=  "			</p>";
    content_3 +=  "  	</li>";
    content_3 +=  '		<li class="letter__big">';
    content_3 +=  '			<p class="letter__big">';
    content_3 +=  '				<span class="highlighted"><a href="lose.html">Ending your game or make your snake longer</a></span> after getting food.';
    content_3 +=  "			</p>";
    content_3 +=  "  	</li>";
    content_3 +=  "	</ul>";
...
let content_4 =   '	<h3 class="heading heading__dark">';
    ...
    content_4 +=' 				<span class="highlighted"><a href="first_example.html">Example 1</a></span>.';
    content_4 +=  "			</p>";
    content_4 +=  "  	</li>";
    content_4 +=  '		<li class="letter__big">';
    content_4 +=  '			<p class="letter__big">';
    content_4 +=' 				<span class="highlighted"><a href="second_example.html">Example 2</a></span>.';
    content_4 +=  "			</p>";
    content_4 +=  "  	</li>";
    content_4 +=  '		<li class="letter__big">';
    content_4 +=  '			<p class="letter__big">';
    content_4 +=' 				<span class="highlighted"><a href="third_example.html">Example 3</a></span>.';
    content_4 +=  "			</p>";
    content_4 +=  "  	</li>";
    content_4 +=  "	</ul>";
